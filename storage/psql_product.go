...
func (p *PsqlProduct) Create(m *product.Model) error {
	...
	fmt.Println("El producto fue creado correctamente")
...
func (p *PsqlProduct) Update(m *product.Model) error {
	...
	fmt.Println("El registro fue actualizado correctamente")
	return nil
}
...
func (p *PsqlProduct) Delete(id uint) error {
	...
	fmt.Println("El registro fue eliminado correctamente")
